...
const refreshForm = () => {
  book_title.value = book_title.defaultValue;
  book_author.value = book_author.defaultValue;
  book_pages.value = book_pages.defaultValue;
  book_read.value = book_read.defaultValue;
};

submit.addEventListener("click", (event) => {
  if (
    book_title.value.length > 0 &&
    book_author.value.length > 0 &&
    book_pages.value.length > 0
  ) {
